...
<head>
    ...
    <style>
        ...
        .pub-logo:hover .pub-logo__img { opacity: 0.88; transform: scale(1.03); }
        .pub-logo--footer .pub-logo__img { height: 72px; }
        ...
        .pub-nav__links a::after {
            ...
            background: var(--brand-gold); transform: scaleX(0);
            transform-origin: left; transition: transform 0.22s;
        }
        .pub-nav__links a:hover { color: var(--brand-gold); }
        ...
        .pub-mobile-menu {
            ...
            z-index: 300; background: #020202;
            flex-direction: column; padding: 32px 24px; gap: 24px;
        }
        .pub-mobile-menu.open { display: flex; }
        .pub-mobile-menu__close {
            align-self: flex-end; background: none; border: none;
            color: #666; font-size: 24px; line-height: 1; cursor: pointer;
        }
        .pub-mobile-menu__close:hover { color: #fff; }
        .pub-mobile-menu nav { display: flex; flex-direction: column; gap: 18px; }
        ...
        .pub-mobile-menu nav a:hover { color: var(--brand-gold); }

        /* ── Main content area ───────────────────────────────────────── */
        .pub-main {
            min-height: 100vh;
            background: linear-gradient(170deg, #000 0%, #0a0a0a 40%, #111 100%);
        }
        ...
        .pub-footer__col a:hover { color: #ccc; }

        .pub-footer__social-link {
            display: flex !important; align-items: center; gap: 8px;
        }
        .pub-footer__social-link svg { flex-shrink: 0; opacity: 0.5; transition: opacity 0.2s; }
        .pub-footer__social-link:hover svg { opacity: 0.9; }
        .pub-footer__social-link:hover { color: var(--brand-gold) !important; }

        .pub-footer__newsletter h4 {
            font-size: 10px; font-weight: 700; text-transform: uppercase;
            letter-spacing: 0.14em; color: var(--text-muted); margin-bottom: 8px;
        }
        .pub-footer__newsletter p { font-size: 12px; color: #383838; margin-bottom: 14px; }
        ...
        .pub-footer__newsletter-form input {
            ...
            color: #ccc; font-size: 13px; padding: 9px 12px;
            border-radius: 6px; outline: none;
            transition: border-color 0.2s;
        }
        .pub-footer__newsletter-form input:focus { border-color: var(--brand-gold-border); }
        .pub-footer__newsletter-form input::placeholder { color: #333; }
        ...
        .pub-footer__newsletter-form button:hover { background: var(--brand-gold-hover); }

        .pub-footer__bottom {
            display: flex; align-items: center; justify-content: space-between;
            gap: 16px; flex-wrap: wrap;
        }
        .pub-footer__copy { font-size: 12px; color: #2a2a2a; }
        .pub-footer__copy a { color: #2a2a2a; text-decoration: none; transition: color 0.2s; }
        .pub-footer__copy a:hover { color: #888; }

        .pub-footer__socials { display: flex; gap: 8px; }
        ...
        @media (max-width: 1024px) {
            .pub-footer__top { grid-template-columns: 1fr 1fr; gap: 32px; }
        }
        @media (max-width: 768px) {
            .pub-nav { padding: 0 18px; }
            .pub-nav__links, .pub-nav__actions .btn-ghost { display: none; }
            .pub-hamburger { display: flex; }
            .pub-footer { padding: 44px 18px 28px; }
            .pub-footer__top { grid-template-columns: 1fr; gap: 24px; }
...
<body class="bg-dark-page text-dark antialiased">
    ...
    <header class="pub-nav" id="pubNav">
        <div class="pub-nav__inner">
            ...
            <div class="pub-nav__actions">
                @guest
                    <a href="{{ route('login') }}" class="btn-ghost">Member Login</a>
                ...
                @else
                    @if(auth()->user()->role === 'admin')
                        <a href="{{ route('admin.dashboard') }}" class="btn-ghost">Admin Panel →</a>
                    @else
                        <a href="{{ route('portal.dashboard') }}" class="btn-ghost">My Dashboard →</a>
                    @endif
                @endguest
            </div>
    ...
    <div class="pub-mobile-menu" id="pubMobileMenu">
        ...
        @guest
            <a href="{{ route('register') }}" class="btn-gold" style="align-self:flex-start; font-size:15px; padding:13px 26px; margin-top:8px;">
                Join Now
            </a>
        @endguest
    </div>
        ...
        <div class="pub-footer__inner">
            ...
            <div class="pub-footer__top">
                ...
                <div class="pub-footer__col">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="#" rel="noopener" class="pub-footer__social-link">
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M22.54 6.42a2.78 2.78 0 0 0-1.95-1.96C18.88 4 12 4 12 4s-6.88 0-8.59.46a2.78 2.78 0 0 0-1.95 1.96A29 29 0 0 0 1 12a29 29 0 0 0 .46 5.58A2.78 2.78 0 0 0 3.41 19.6C5.12 20 12 20 12 20s6.88 0 8.59-.46a2.78 2.78 0 0 0 1.95-1.95A29 29 0 0 0 23 12a29 29 0 0 0-.46-5.58z"/><polygon points="9.75 15.02 15.5 12 9.75 8.98 9.75 15.02" fill="#050505"/></svg>
                                YouTube
                            </a>
                        </li>
                    </ul>
            ...
            <div class="pub-footer__bottom">
                <p class="pub-footer__copy">
                    &copy; {{ date('Y') }} Amigos Fitness Gym. All rights reserved.
                    &nbsp;·&nbsp; <a href="#">Privacy</a>
                    &nbsp;·&nbsp; <a href="#">Terms</a>
                </p>
