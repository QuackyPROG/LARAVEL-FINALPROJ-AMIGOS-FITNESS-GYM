    ...
    <main class="relative z-10 w-full max-w-7xl mx-4 flex flex-col md:flex-row rounded-2xl overflow-hidden glass-card gold-glow">
        ...
        <div class="w-full md:w-1/2 p-8 md:p-16 flex flex-col justify-center relative">
            ...
            <div class="mb-8 text-center">
                <h1 class="text-3xl font-bold tracking-tight mb-2">Reset Your Password</h1>
                <p class="text-gray-400 text-sm">Choose a strong new password for your account.</p>
            </div>
                ...
                <div>
                    ...
                    <div class="relative flex items-center">
                        ...
                        <input
                            ...
                            required
                            readonly
                            class="w-full bg-white/5 border border-gray-700 rounded-xl py-3 pl-12 pr-4 text-lg text-gray-400 placeholder-gray-600 focus:outline-none cursor-not-allowed"
                        >
                    </div>
                </div>
